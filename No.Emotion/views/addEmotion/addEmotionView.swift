    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false) {
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Button(action: {
                        ...
                        Image(systemName: "paperplane")
                            ...
                            .opacity(self.dataSelected.isEmpty ? 0.3 : 1.0)
                    ...
                    ForEach(self.logic.smiles, id: \.self) { item in
                        Button(action: {
                            ...
                            Text(item)
                                .font(.system(size: 32))
                                .padding()
                                .background(self.dataSelected.contains(item) ? self.logic.getSmileColor(smile: item)
                                    .opacity(0.3) : Color.secondary.opacity(0.1))
                                .cornerRadius(8)
                                .drawingGroup()
                ...
                HStack {
                    Text(
                        "You can add an unlimited number of moments during the day. Write down everything that happens to you - moments of happiness and joy, sadness and sorrow. The more you add, the better the picture will be during the month and we will be able to give you useful advice."
                    )
                    .font(.custom("SourceCodePro-Regular", size: 14))
                    .foregroundColor(Color.secondary.opacity(0.7))
                    Spacer()
